...
public class ConnectionsService {
    ...
    public ConnectionsService(PersonRepository personRepository, KafkaTemplate<Long, SendConnectionRequestEvent> sendRequestKafkaTemplate, KafkaTemplate<Long, AcceptConnectionRequestEvent> acceptRequestKafkaTemplate) {
